...
public class Products_List extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customType(Products_List.this,"left-to-right");
        /**left-to-right
         *right-to-left
         *bottom-to-up
         *up-to-bottom
        ...
        adapters = new Adapters( Products_List.this,list );
        // list.clear();
        listview.setAdapter( adapters );
        final String URL= getText(R.string.URL_string).toString();
        final String url = URL+"product_list.php";
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                String T_title = "Products List";
                String c_url =String.valueOf(list.get(position).get_course_image()); ;



                Intent i = new Intent(Products_List.this, Details_View.class);
